...
@foreach ($SiteSettings as $settings)
    ...
    <meta charset="UTF-8">
        ...
        <?php $Blog = DB::table('blog')->limit(1)->inRandomOrder()->get();  ?>
        @foreach ($Blog as $item)
        <title> New Updates | Creation Office Fitouts</title>
       
   
         <meta name="description" content="{{$item->meta}}" />
         <meta name="keywords" content="Creation office Fitouts, Interior Design " />
         <meta name="author" content="Designekta Studios" />
         <link rel="canonical" href="{{url('/')}}/news-updates/{{$item->slung}}"/>
         
      
         <meta property="og:description" content="{{$item->meta}}">
         <meta property="og:image" content="https://www.creationltd.co.ke/uploads/blog/{{$item->image_one}}" />
         <meta property="og:image:secure_url" content="https://www.creationltd.co.ke/uploads/blog/{{$item->image_one}}">
         {{-- <meta property="fb:page_id" content="1359118687432239" /> --}}
         <meta property="og:title" content="New Updates | Creation Office Fitouts" />
         <meta property="og:url" content="{{url('/')}}news-updates/{{$item->slung}}" />
         ...
         <meta name="twitter:title" content="New Updates | Creation Office Fitouts">
         <meta name="twitter:description" content="{{$item->meta}}">
         <meta name="twitter:image" content="https://www.creationltd.co.ke/uploads/blog/{{$item->image_one}}">
