               ...
               <div class="main_menu" id="mainNav">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h wow fadeInUp" data-wow-duration="1s" data-wow-delay="100ms" href="{{url('/')}}"><img width="250" height="auto" src="{{url('/')}}/uploads/logo/{{$Settings->logo}}" alt=""><img width="200" height="auto" src="{{url('/')}}/uploads/logo/{{$Settings->logo}}" alt=""></a>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-12">
                        ...
                        @foreach($Sitesettings as $Settings)
                            ...
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay="600ms">{!!html_entity_decode($Settings->welcome)!!}</p>
                            <h4>Working Hours: </h4>
