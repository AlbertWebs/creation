...
Route::get('/shop/website','HomeController@website');
Route::get('/shop/website/cat/{cat}','HomeController@website_cat');
Route::get('/shop/website/{name}','HomeController@website_details');
Route::get('/shop/website/link/{name}','HomeController@link');
Route::get('/shop/cat/{cat}','HomeController@shop_cat');
Route::get('/shop/{name}','HomeController@shop_details');
Route::get('/portfolio','HomeController@portfolio');
Route::get('/portfolio/{name}','HomeController@portfolio_single');
Route::get('/contact','HomeController@contact');
Route::get('/services','HomeController@services');
Route::get('/service/{name}','HomeController@service');
...
//BlogRoutes
Route::get('/news-updates','BlogController@index');
Route::get('/news-updates/{slung}','BlogController@blog');
Route::get('/news-updates/category/{slung}','BlogController@blogCat');
